...
```
# Installer pyenv: https://github.com/pyenv/pyenv
pyenv install 3.10.6
pyenv virtualenv 3.10.6 gilded-rose
pyenv local gilded-rose
# Installer poetry: https://python-poetry.org/docs/
poetry install
# Installer mob.sh si vous voulez faire du mob/pair programming: https://mob.sh/

```

# Histoire de la Rose dorée
